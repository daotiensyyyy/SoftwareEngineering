...
public class CaptchaUtils {
    ...
    public static final String SITE_KEY = "6LfvybwZAAAAALP0QrropENpVU2CpCcAP6HS7GbF";
    public static final String SECRET_KEY = "6LfvybwZAAAAAANah80UVWFfXIOjoPS3fUb_gTkn";
