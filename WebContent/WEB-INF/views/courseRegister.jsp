						...
						<div
							...
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									...
									<li class="active"><a href="Course">Đăng ký môn học</a></li>
					...
					<tr>
						...
						<td><a type="submit"
							href="Course?course_id=${course.course_id }">
								<button class="btn btn-primary" id="select">Choose</button>
						</a></td>
					</tr>
				</c:forEach>
			</tbody>
			...
			<table class="table">
				...
				<thead class="thead-dark">
					<tr>
						...
						<!-- 					<th>Ngày bắt đầu</th> -->
						<!-- 					<th>Ngày kết thúc</th> -->
						<th><button type="submit" class="btn btn-light">Save</button></th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${lstCart }" var="cart">
						<tr>
							<td><input id="course_id" type="text" class="input"
								value="${cart.course_id}" name="course_id" readonly /></td>
							<td><input id="course_name" type="text" class="input"
								value="${cart.course_name}" name="course_name" readonly /></td>
							<td><input id="credits" type="text" class="input"
								value="${cart.course_credits}" name="credits" readonly /></td>
							<td><input id="day" type="text" class="input"
								value="${cart.day}" name="day" readonly /></td>
							<td><input id="room" type="text" class="input"
								value="${cart.room}" name="room" readonly /></td>
							<td><input id="semester" type="text" class="input"
								value="${cart.semester}" name="semester" readonly /></td>
							<!-- 						<td><input id="start" type="text" class="input" -->
							<%-- 							value="${cart.start_time}" name="start" readonly /></td> --%>
							<!-- 						<td><input id="end" type="text" class="input" -->
							<%-- 							value="${cart.end_time}" name="end" readonly /></td> --%>
